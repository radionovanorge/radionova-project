...
function toggleRadio(){const radioPlayer=document.getElementById('radio-player');const playIcon=document.getElementById('play-radio-icon');if(radioPlayer.paused){radioPlayer.play();playIcon.className='fa fa-pause';playIcon.innerHTML=' Pause';}else{radioPlayer.pause();playIcon.className='fa fa-play';playIcon.innerHTML=' Play';}};