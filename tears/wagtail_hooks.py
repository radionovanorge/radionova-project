...
def manuals_index_view(request):
    ...
    return render(request, 'wagtailadmin/manuals/index.html', {
...
def manual_detail_view(request, manual_id):
    ...
    return render(request, 'wagtailadmin/manuals/detail.html', {
        'manual': manual
    })
...
class BeskjedPanel(Component):
    ...
    def get_context_data(self, parent_context):
        return {
            "beskjed": BeskjedFraDagtid.objects.first()
        }
